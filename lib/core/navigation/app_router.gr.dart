...
class AddProductScreenRoute extends _i11.PageRouteInfo<void> {
  const AddProductScreenRoute({List<_i11.PageRouteInfo>? children})
...
class ChatScreenRoute extends _i11.PageRouteInfo<void> {
  const ChatScreenRoute({List<_i11.PageRouteInfo>? children})
...
class FavoriteScreenRoute extends _i11.PageRouteInfo<void> {
  const FavoriteScreenRoute({List<_i11.PageRouteInfo>? children})
...
/// generated route for
/// [_i4.MainShell]
class MainShellRoute extends _i11.PageRouteInfo<void> {
  const MainShellRoute({List<_i11.PageRouteInfo>? children})
...
class ProductDetailsScreenRoute
    extends _i11.PageRouteInfo<ProductDetailsScreenRouteArgs> {
...
class ProductListScreenRoute
    extends _i11.PageRouteInfo<ProductListScreenRouteArgs> {
  ProductListScreenRoute({_i12.Key? key, List<_i11.PageRouteInfo>? children})
    : super(
...
class ProductSearchBarRoute
    extends _i11.PageRouteInfo<ProductSearchBarRouteArgs> {
  ProductSearchBarRoute({
    _i12.Key? key,
    required _i12.ValueChanged<String> onChanged,
    required _i12.TextEditingController controller,
    List<_i11.PageRouteInfo>? children,
  }) : super(
...
class ProductSearchBarRouteArgs {
  ...
  final _i12.ValueChanged<String> onChanged;

  final _i12.TextEditingController controller;
...
class ProfileDetailsRoute extends _i11.PageRouteInfo<void> {
  const ProfileDetailsRoute({List<_i11.PageRouteInfo>? children})
  ...
  static _i11.PageInfo page = _i11.PageInfo(
    name,
    builder: (data) {
      return const _i8.ProfileDetails();
    },
  );
}
...
/// generated route for
/// [_i9.ProfileOptions]
class ProfileOptionsRoute extends _i11.PageRouteInfo<void> {
  const ProfileOptionsRoute({List<_i11.PageRouteInfo>? children})
  ...
  static _i11.PageInfo page = _i11.PageInfo(
    name,
    builder: (data) {
      return const _i9.ProfileOptions();
    },
  );
}
